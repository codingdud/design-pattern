...
- [KISS — Keep It Simple](principles/kiss.md)
...
- [Open / Closed](solid/open-closed.md)
- [Liskov Substitution](solid/liskov-substitution.md)
- [Interface Segregation](solid/interface-segregation.md)
- [Dependency Inversion](solid/dependency-inversion.md)
